...
export default function Clients() {
  ...
  // Fetch all clients and categories
  ...
  return (
    <>
      <div className="flex mt-5 px-3 sm:mt-2 items-center justify-between mb-4">
        <p className="text-xl font-medium sm:pb-0">Clients</p>
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger asChild>
            ...
            >
              <span className="hidden md:block">Add Clients</span>
              <PlusIcon />
            </Button>
          </DialogTrigger>
          <DialogContent
